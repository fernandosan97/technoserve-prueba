...
class ClienteSecretariaController extends Controller
{
  public function index(Request $request) {
    ...
    if (isset($filtroTipo) && empty($filtroTipo)) {
      return redirect()->route('secretaria.clientes');
    }
    ...
    return view('secretaria.clientes.index', [
        'clientes' => $usuarios,
  ...
  public function create() {
    return view('secretaria.clientes.create'); // Vista del formulario de registro
  }

  public function edit(Cliente $cliente) {
    return view('secretaria.clientes.edit', ['cliente' => $cliente]);
  }
  ...
  public function store(Request $request) {
    ...
    return redirect()->route('secretaria.clientes')->with('success', 'Cliente creado exitosamente');
  }
  ...
  public function update(Request $request, Cliente $cliente) {
      ...
      return redirect()->route('secretaria.clientes')->with('success', 'Cliente actualizado exitosamente');
    }

    public function destroy(Cliente $cliente) {
      $cliente->delete();
  
      return redirect()->route('secretaria.clientes')->with('success', 'Cliente eliminado exitosamente');
    }
}
